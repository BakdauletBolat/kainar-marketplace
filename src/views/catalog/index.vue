            ...
            <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
              ...
              <DialogPanel
                ...
                <form class="mt-4 border-t border-gray-200">
                  ...
                  <Disclosure as="div" v-for="section in catalogStorage.filters" :key="section.id"
                    ...
                    <DisclosurePanel class="pt-6">
                      <div class="space-y-6">
                        <div v-for="(option, optionIdx) in section.options" :key="option.value" class="flex items-center">
                          <input @click="catalogStorage.updateSelectedValues(section.id, option.value)" :id="`filter-mobile-${section.id}-${optionIdx}`" :name="`${section.id}[]`"
            ...
            <form class="hidden lg:block">
              ...
              <Disclosure as="div" v-for="section in catalogStorage.filters" :key="section.id"
                ...
                <DisclosurePanel class="pt-6">
                  <div class="space-y-4">
                    <div v-for="(option, optionIdx) in section.options" :key="option.value" class="flex items-center">
                      <input :id="`filter-${section.id}-${optionIdx}`" :name="`${section.id}[]`" @click="catalogStorage.updateSelectedValues(section.id, option.value)" :value="option.value"
